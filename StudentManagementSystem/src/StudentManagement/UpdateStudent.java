...
public class UpdateStudent extends JFrame {
	...
	private JTextField addU;
	private JTextField scoreU;
	...
	public UpdateStudent() {
		...
		JLabel lblNewLabel_1_5 = new JLabel("Score");
		...
		scoreU = new JTextField();
		scoreU.setColumns(10);
		...
		updateBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "UPDATE `student` SET name=?, id=?, email=?, contactnumber=?, address=?, score=? WHERE id=?";
					con = DriverManager.getConnection("jdbc:mysql://localhost/studentmanagementsystem", "root", "1234");
					pst=con.prepareStatement(query);
					
					String pid = updateID.getText();
					pst.setString(1, nameU.getText());
					pst.setString(2, idU.getText());
					pst.setString(3, emailU.getText());
					pst.setString(4, contactU.getText());
					pst.setString(5, addU.getText());
					pst.setString(6, scoreU.getText());
					pst.setString(7, pid);
					if(nameU.getText().equals("") || idU.getText().equals("") || emailU.getText().equals("") || contactU.getText().equals("") || addU.getText().equals("")|| scoreU.getText().equals("")) {
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(lblNewLabel_1_3, GroupLayout.PREFERRED_SIZE, 116, GroupLayout.PREFERRED_SIZE)
									.addComponent(lblNewLabel_1_4, GroupLayout.PREFERRED_SIZE, 116, GroupLayout.PREFERRED_SIZE)
									.addComponent(lblNewLabel_1_5, GroupLayout.PREFERRED_SIZE, 116, GroupLayout.PREFERRED_SIZE))
									.addPreferredGap(ComponentPlacement.RELATED, 383, Short.MAX_VALUE)))
						.addGap(70)))
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(idU, GroupLayout.PREFERRED_SIZE, 207, GroupLayout.PREFERRED_SIZE)
						...
						.addComponent(addU, GroupLayout.PREFERRED_SIZE, 207, GroupLayout.PREFERRED_SIZE)
						.addComponent(scoreU, GroupLayout.PREFERRED_SIZE, 207, GroupLayout.PREFERRED_SIZE))
					.addGap(114))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(261)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(idU, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE))
					.addGap(26)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
					...
					.addGap(27)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addComponent(addU, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblNewLabel_1_4, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE))
					.addGap(27)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addComponent(scoreU, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
		...
		JLabel lblNewLabel = new JLabel("Search the \"ID\"");
