...
public class RemoveStudent extends JFrame {
	...
	public RemoveStudent() {
		...
		deleteName.setBounds(111, 40, 206, 29);
		desktopPane_1.add(deleteName);
		...
		JLabel lblNewLabel = new JLabel("Enter the \"ID\" of the student");
		lblNewLabel.setForeground(Color.BLACK);
		lblNewLabel.setBounds(80, 90, 408, 25);
